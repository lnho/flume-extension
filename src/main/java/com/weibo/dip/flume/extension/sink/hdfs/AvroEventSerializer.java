...
/**
 * <p>
 * This class serializes Flume {@linkplain org.apache.flume.Event events} into
 * Avro data files. The Flume event body is read as an Avro datum, and is then
 * written to the {@link org.apache.flume.serialization.EventSerializer}'s
 * output stream in Avro data file format.
 * </p>
 * <p>
